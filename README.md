# 🚆 Vahana - IRCTC Microservices Railway Ticket Reservation System

> A production-grade microservices-based railway booking system platform built with Node.js, Express, React, PostgreSQL, Redis, Kafka, and Elasticsearch.

**Repository Owner & Maintainer**: [Mohd Farhan Ansari](https://github.com/FarhanAnsari124)
...
```bash
git clone https://github.com/FarhanAnsari124/Vahana-IRCTC_Inspired_Railway_Ticket_Reservation_System.git
cd Vahana-IRCTC_Inspired_Railway_Ticket_Reservation_System
```
